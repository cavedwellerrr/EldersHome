...
const EditMealModal = ({ open, onClose, meal, onUpdated }) => {
    ...
    const addInclude = () => setToInclude((prev) => pushUnique(prev, currentInclude)) || setCurrentInclude("");
    const addAvoid = () => setToAvoid((prev) => pushUnique(prev, currentAvoid)) || setCurrentAvoid("");
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={onClose}>
                ...
                >
                    ...
                    <div className="flex items-center justify-between px-6 py-4 rounded-t-3xl bg-[#FFF2EA] border-b border-[#F4D7C8]">
                        <h3 className="text-xl md:text-2xl font-semibold text-neutral-900">Edit Meal</h3>
                        <button
