...
const imagesMap = {
  "Health Checkup Camp": "/images/health.jpg",
  "Weekend Movie Night": "/images/movie.jpg",
  "Friendly Card Game Evening": "/images/card.jpg",
  "Morning Yoga": "/images/yoga.jpg",
  "Gardening Workshop": "/images/gardening.jpg",
};

const DefaultImg = "/images/default.jpg"; // fallback
    ...
    const fetchEvents = async () => {
      try {
        ...
        const eventsWithImages = data.map((event) => ({
          ...event,
          image: imagesMap[event.title] || event.image || DefaultImg,
        }));
