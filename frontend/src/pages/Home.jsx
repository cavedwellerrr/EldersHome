...
import { Heart, Users, Calendar, Stethoscope, Phone, Mail, MapPin, Star, Clock, Shield, MessageCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="section-hero" className="relative h-screen w-full overflow-hidden">
        <div className="absolute inset-0">
          <img src={happyman} alt="Happy seniors with caregiver" className="w-full h-full object-cover" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div
              className={`max-w-4xl transform transition-all duration-1000 ${
                isVisible["section-hero"] ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
              }`}
            >
              ...
              <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl drop-shadow-md leading-relaxed">
                Experience compassionate care in a warm, family-like environment where every day brings joy, comfort,
        ...
        <div
          className={`absolute bottom-8 right-8 bg-white p-6 rounded-xl shadow-2xl transform transition-all duration-1000 delay-500 ${
            isVisible["section-hero"] ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className={`text-center mb-16 transform transition-all duration-1000 ${
              isVisible["section-services"] ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          >
      ...
      <section id="section-events" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className={`text-center mb-16 transform transition-all duration-1000 ${
              isVisible["section-events"] ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className={`grid md:grid-cols-2 gap-12 items-center transform transition-all duration-1000 ${
              isVisible["section-healthcare"] ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          >
            <div>
              <h2 className="text-4xl font-bold mb-6">Professional Healthcare Services</h2>
              <p className="text-xl mb-8 text-orange-100">
                Our qualified medical team provides comprehensive healthcare services including regular check-ups,
                medication management, physical therapy, and emergency care - all within our comfortable facility.
              </p>
            ...
            <div className="relative">
              <img src={healthcare} alt="Healthcare services" className="w-[600px] h-[500px] rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className={`grid grid-cols-2 md:grid-cols-4 gap-8 transform transition-all duration-1000 ${
              isVisible["section-stats"] ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div
            className={`transform transition-all duration-1000 ${
              isVisible["section-cta"] ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          >
      ...
      <button
        onClick={toggleChat}
        className="fixed bottom-5 right-5 bg-orange-500 text-white p-4 rounded-full shadow-lg hover:bg-orange-600 transition-all duration-300 z-50 flex items-center space-x-2"
      >
      ...
      {isChatOpen && <ChatBox userId="guest" />}
    </div>
  );
};
