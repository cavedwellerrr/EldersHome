...
import { Users, UserCheck, UserX, TrendingUp, Download, FileText, FileSpreadsheet, MessageCircle } from "lucide-react";
...
const SimplifiedElderDashboard = () => {
  ...
  const currentGenderData = selectedView === "active" ? dashboardData.activeGenderDistribution : dashboardData.disabledGenderDistribution;
  const currentAgeData = selectedView === "active" ? dashboardData.activeAgeGroups : dashboardData.disabledAgeGroups;
  const currentMonthlyData = selectedView === "active" ? dashboardData.monthlyActiveRegistrations : dashboardData.monthlyDisabledRegistrations;
  const currentTotal = selectedView === "active" ? dashboardData.totalActiveElders : dashboardData.totalDisabledElders;
            ...
            <div className="flex bg-gray-100 rounded-lg p-1">
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                  selectedView === "active" ? "bg-green-600 text-white shadow-sm" : "text-gray-600 hover:text-gray-900"
                }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                  selectedView === "disabled" ? "bg-red-600 text-white shadow-sm" : "text-gray-600 hover:text-gray-900"
                }`}
              >
              ...
              {currentAgeData.length === 0 || currentAgeData.every((item) => item.count === 0) ? (
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={currentAgeData}>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Bar dataKey="count" fill={selectedView === "active" ? "#10B981" : "#EF4444"} radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              )}
            </div>
