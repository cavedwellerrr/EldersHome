// Import React hooks and axios instance
...
const DoctorMedicalRecords = () => {
    ...
    const fetchElders = async () => {
        try {
            ...
            setElders(res.data); // store elders list
        } catch (err) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                ...
                await api.post(`/elders/${elderId}/medicalrecords`, { recordType, notes });
    ...
    return (
        <div className="p-8 text-gray-900">
            ...
            >
                ...
                <button
                    type="submit"
                    className={`px-5 py-2 rounded font-semibold text-white ${editingId
                        ...
                        {records.length > 0 ? (
                            records.map((rec) => (
                                <tr key={rec._id} className="border-t hover:bg-gray-50">
                                    <td className="p-3">{rec.elderId?.fullName || "Unknown Elder"}</td>
